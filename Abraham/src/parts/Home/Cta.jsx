...
export default function Cta() {
  return (
    <section className="text-white px-5 py-5 md:grid md:grid-cols-2 md:px-5 md:gap-2 md:py-10 lg:px-20 lg:gap-8 lg:py-14 xl:px-32 xl:py-16 xl:gap-14">
      ...
      <div className="md:text-lg lg:text-xl xl:text-2xl">
        <form className="">
          ...
          <button
            className="bg-yellow_custom w-full h-14 font-sen font-bold"
            type="submit"
          >
            LET'S GET STARTED
          </button>
